Contributing to MecuAI Core
============================

The MecuAI Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mecuai/mecuai/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the MecuAI Core project (and related
projects such as libsecp256k1), and is not to be confused with overall MecuAI
Network Protocol consensus changes.

Whether a pull request is merged into MecuAI Core rests with the project merge
...
Patches that change MecuAI consensus rules are considerably more involved than
...
Where a patch set proposes to change the MecuAI consensus, it must have been
...
The review process is normally fairly responsive on the MecuAI Core repository, however
...
The project leader is the release manager for each MecuAI Core release.
