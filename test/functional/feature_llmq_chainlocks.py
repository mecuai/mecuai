...
from test_framework.test_framework import MecuAITestFramework
...
class LLMQChainLocksTest(MecuAITestFramework):
    def set_test_params(self):
        self.set_mecuai_test_params(6, 5, fast_dip3_enforcement=True)
