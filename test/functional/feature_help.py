...
"""Verify that starting mecuaid with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mecuaid with -h for help text")
        ...
        self.log.info("Start mecuaid with -version for version information")
