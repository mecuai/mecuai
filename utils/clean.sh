...
rm -f src/config/mecuai-config.h
...
rm -rf test_bitcoin.coverage/ mecuai-gtest.coverage/ total.coverage/
...
clean_exe src/mecuai-cli
clean_exe src/mecuaid
clean_exe src/mecuai-gtest
clean_exe src/mecuai-tx
clean_exe src/test/test_mecuai
clean_exe src/test/test_mecuai_fuzzy
...
clean_dep . src/config/mecuai-config.h.in
