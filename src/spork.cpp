...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_17_QUORUM_DKG_ENABLED,            0000000001ULL), // OFF
    MAKE_SPORK_DEF(SPORK_19_CHAINLOCKS_ENABLED,            0000000001ULL), // OFF
    MAKE_SPORK_DEF(SPORK_21_LOW_LLMQ_PARAMS,               4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_22_SPECIAL_TX_FEE,                0000000001ULL), // OFF mean chain would take any fee for special tx as valid
    MAKE_SPORK_DEF(SPORK_23_QUORUM_ALL_CONNECTED,          0000000001ULL), // OFF
