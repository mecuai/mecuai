...
{
    const char* pszTimestamp = "Artificial Intelligence is a subset of machine learning for MECUAI Chain";
    const CScript genesisOutputScript = CScript() << ParseHex("04a6bce727025436e5d2dbd40ce5f42db2df440b04dd5d18622c1cff47fa92a8817b5525dbddeded81109dbc0e00bd01478cd42bd74a835389b69bf3f42c6a3cd5") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nSmartnodePaymentsStartBlock = 3168; //
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // MecuAI: 1 day
        consensus.nPowTargetSpacing = 2 * 68; // MecuAI: 2 minutes
        ...
        genesis = CreateGenesisBlock(1684696218, 6098, 0x20001fff, 4, 5000 * COIN);
        VerifyGenesisPOW(genesis);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9b483fcf1ab4b906d5659cd53f54391487e920612626613eeb88e5a7f21957cb"));
        assert(genesis.hashMerkleRoot == uint256S("0x4229638f899146b4b3a2f3caed8f5ec049091e443a42b8d28ab5f8fe5ff3743c"));

        vSeeds.emplace_back("node.mecuai.com");
        vSeeds.emplace_back("nddl.mecuai.com");
        vSeeds.emplace_back("ndld.mecuai.com");
        vSeeds.emplace_back("ndny.mecuai.com");                


        // MecuAI addresses start with 'M'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);
        // MecuAI script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // MecuAI private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // MecuAI BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // MecuAI BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // MecuAI BIP44 coin type is '5'
...
//        }
        ...
        vSporkAddresses = {"MH3fzbxRApHKQPWX5VwTSoDhBgzYZt3eVP"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // MecuAI: 1 day
        consensus.nPowTargetSpacing = 60; // MecuAI: 1 minutes
        ...
        vSeeds.emplace_back("tst.mecuai.com");

        // Testnet MecuAI addresses start with '
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Testnet MecuAI script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet MecuAI BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet MecuAI BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet MecuAI BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 272200, "TH3tgrfjzbxyuiyidSoDhBgzYZt3eVP");
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // MecuAI: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // MecuAI: 2 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
...
//      std::cout << "hash: " << consensus.hashGenesisBlock.ToString() << std::endl;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("mecuaievo.org",  "devnet-seed.mecuaievo.org"));

        // Testnet MecuAI addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest MecuAI addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest MecuAI script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest MecuAI BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest MecuAI BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest MecuAI BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
