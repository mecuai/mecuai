    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  mecuai-qt [command-line options]                     \n";
...
All the MecuAI in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 MECU, 0.01 MECU, 0.1 MECU, 1 MECU and 10 MECU -- sort of like the paper money you use every day.</li> \
