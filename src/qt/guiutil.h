...
/** Utility functions used by the MecuAI Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "mecuai:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load mecuai specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a mecuai specific theme is activated (light/dark).*/
