...
/* MecuAIGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* MecuAIGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "MecuAI"
#define QAPP_ORG_DOMAIN "mecuai.com"
#define QAPP_APP_NAME_DEFAULT "MecuAI-Qt"
#define QAPP_APP_NAME_TESTNET "MecuAI-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "MecuAI-Qt-%s"
#define QAPP_APP_NAME_REGTEST "MecuAI-Qt-regtest"
