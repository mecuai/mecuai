...
//! Interface for the src/evo part of a mecuai node (mecuaid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a mecuai node (mecuaid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a mecuai node (mecuaid process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a mecuai node (mecuaid process).
class Node
{
public:
    virtual ~Node() {}
