...
This mechanism has been integrated into Bitcore-Node-MecuAI which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mecuai/insight-api-mecuai#web-socket-api](https://github.com/mecuai/insight-api-mecuai#web-socket-api)
* API: [https://github.com/mecuai/insight-api-mecuai#instantsend-transactions](https://github.com/mecuai/insight-api-mecuai#instantsend-transactions)
