...
* mecuai.conf: contains configuration settings for mecuaid or mecuai-qt
* mecuaid.pid: stores the process id of mecuaid while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by mecuaid or mecuai-qt
